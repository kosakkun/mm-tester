# Rectilinear Traveling Salesman

## 問題文
$xy$ 平面上に座標が重複しない $N$ 個の頂点が与えられます．頂点には $0$ から $N-1$ の番号が振られており，$i$ 番目の頂点の座標は $(x_{i}, y_{i})$ です．頂点間の距離をマンハッタン距離とします．全ての頂点を一度ずつ通って出発点に戻ってくる経路でなるべく移動距離が小さいものを出力してください．
